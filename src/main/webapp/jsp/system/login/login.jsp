		...
		<div class="easyui-panel" style="width:400px;padding:30px 60px">
			<form id="login-form" method="post">
		        ...
		        <div style="margin-bottom:20px">
		            <input class="easyui-textbox" id="username" name="username" prompt="请输入用户名" required="true" missingMessage="请输入用户名" iconCls="icon-man" iconWidth="28" style="width:100%;height:34px;padding:10px;">
		        </div>
		        <div style="margin-bottom:20px">
		            <input class="easyui-passwordbox" id="password" name="password" prompt="请输入密码" required="true" missingMessage="请输入密码" iconWidth="28" style="width:100%;height:34px;padding:10px">
		        </div>
		        <div style="margin-bottom:20px">
		            <a href="#" class="easyui-linkbutton" onclick="login()" style="width:100%;height:36px">登 &nbsp;&nbsp;录</a>
		        </div>
			</form>
	    </div>
    </div>
